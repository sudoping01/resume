...
* **BambaraMLLM: A Unified Multilingual Multimodal Large Language Model for Comprehensive Bambara Language Processing**. **EACL 2026 AfricaNLP Workshop** (Accepted).
...
* **Where Are We At with Automatic Speech Recognition for the Bambara Language?** **EACL 2026 AfricaNLP Workshop** (Accepted).
...
* **InstructLR: A Scalable Approach to Create Instruction Dataset for Under-Resourced Languages**. **EACL 2026 AfricaNLP Workshop** (Accepted).
